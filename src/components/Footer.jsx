                    ...
                    <div className="flex flex-col items-start">
                        ...
                        <Link to="/" className="flex items-center gap-3 mb-6 group">
                            ...
                            <span className="text-3xl font-serif font-bold text-white tracking-widest group-hover:text-amber-500 transition-colors">
                               Bircuz Lipa 1880<span className="text-amber-500 font-bold">.</span>
                            </span>
                        </Link>
                        ...
                        <ul className="space-y-6">
                            ...
                            <li className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 text-sm">{t('footer.city')}</p>
                                </div>
                            </li>
                            ...
                            <li className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-gray-500 text-sm mb-1">{t('footer.reservations')}</p>
