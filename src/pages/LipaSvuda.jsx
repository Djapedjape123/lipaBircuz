...
function LipaSvuda() {
    ...
    return (
        <>
            {/* --- SEO SEKCIJA ZA "LIPA SVUDA" --- */}
            <SEO 
                title="Lipa Svuda | Putujemo svetom | Bircuz Lipa 1880"
                description="Gde god da krenu, naši gosti nose delić Lipe sa sobom. Pogledajte priče i fotografije sa putovanja naših Lipadžija širom sveta."
            />
