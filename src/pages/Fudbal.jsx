    ...
    return (
        <>
            ...
            <div className="lg:col-span-6 order-2 pt-24 px-6 pb-24 lg:order-1 lg:self-start">
                ...
                <div className="hidden md:block absolute bottom-20 left-10 text-[15rem] text-yellow-700/20 rotate-12 select-none pointer-events-none">
                    <FaTrophy />
                </div>
                            ...
                            <div className="space-y-8 text-gray-700 leading-relaxed font-light text-justify">
                                ...
                                <div className="relative pl-6 border-l-4 border-amber-500/40 py-2 bg-amber-50/30 rounded-r-xl">
                                    <p className="text-lg md:text-xl text-emerald-950 font-serif italic">
                                        {t('football.intro_quote_1')}<strong className="text-emerald-700 not-italic decoration-amber-400 underline decoration-2 underline-offset-4">{t('football.intro_quote_lipadzije')}</strong>{t('football.intro_quote_2')}
                                    </p>
                                </div>
                                ...
                                <div className="mt-6 bg-gradient-to-br from-white to-emerald-50 rounded-2xl p-8 shadow-lg border border-emerald-100 relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <h3 className="font-bold text-emerald-950 text-base uppercase tracking-wider">{t('football.path_to_success')}</h3>
                                        </div>

                                        <p className="mb-6 text-gray-700">
                                            {t('football.success_1')}
                                        </p>
                                        ...
                                        <div className="bg-white/80 backdrop-blur-sm p-5 rounded-xl border-l-4 border-emerald-500 shadow-sm">
                                            <p className="font-medium text-emerald-900 leading-relaxed">
                                                {t('football.success_2_start')}<span className="font-bold text-amber-600">{t('football.success_2_h1')}</span>{t('football.success_2_mid')}<span className="font-bold text-amber-600">{t('football.success_2_h2')}</span>{t('football.success_2_end')}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                >
                    <div className="text-center mb-8">
                        <span className="text-amber-600 font-bold uppercase tracking-[0.2em] text-xs mb-2 block">{t('football.video_badge')}</span>
                        <h2 className="text-3xl font-serif text-emerald-950">{t('football.video_title_1')} <br />{t('football.video_title_2')}</h2>
                    </div>
