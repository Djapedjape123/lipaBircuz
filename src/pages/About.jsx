...
import img2 from '../assets/lipaIstorija.webp'
                ...
                >
                    ...
                    <div>
                        ...
                        <h1 className="text-4xl md:text-6xl font-serif font-medium text-emerald-950 mb-6 mt-5 leading-tight">
                            {t('about_page.title_main')} <br/>
                            <span className="text-2xl md:text-3xl text-emerald-800/60 italic font-light block mt-2">
                                {t('about_page.title_sub')}
                            </span>
                        </h1>
