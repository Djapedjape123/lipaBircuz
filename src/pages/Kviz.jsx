...
const IMAGES = [
    img1, 
    'https://res.cloudinary.com/duomot4hp/image/upload/q_auto/f_auto/v1777887328/kviz2_hoa0iu.jpg', 
    'https://res.cloudinary.com/duomot4hp/image/upload/q_auto/f_auto/v1777887363/kviz3_ue0xwr.jpg', 
    img4, 
    img5, 
    img6, 
    img7
...
function Kviz() {
    ...
    return (
        <>
            {/* --- SEO SEKCIJA ZA KVIZ STRANICU --- */}
            <SEO 
                title="Pab Kviz Ekipa | Bircuz Lipa 1880 Novi Sad"
                description="Pogledaj te našu ekipu koje je harala kvizovima po Novom Sadu."
            />
